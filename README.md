...
**Pipeline:** [![CI/CD](https://img.shields.io/github/actions/workflow/status/Esysc/frontend-backend/ci-cd.yml?label=pipeline)](https://github.com/Esysc/frontend-backend/actions/workflows/ci-cd.yml)
**Pre-commit:** [![pre-commit](https://img.shields.io/github/actions/workflow/status/Esysc/frontend-backend/ci-cd.yml?job=pre-commit&label=pre-commit)](https://github.com/Esysc/frontend-backend/actions/workflows/ci-cd.yml)
**Backend:** [![backend](https://img.shields.io/github/actions/workflow/status/Esysc/frontend-backend/ci-cd.yml?job=backend-tests&label=backend)](https://github.com/Esysc/frontend-backend/actions/workflows/ci-cd.yml)
**Frontend:** [![frontend](https://img.shields.io/github/actions/workflow/status/Esysc/frontend-backend/ci-cd.yml?job=frontend-tests&label=frontend)](https://github.com/Esysc/frontend-backend/actions/workflows/ci-cd.yml)
